...
// fully detached from Prowl's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Prowl's process
// group.
...
// from Prowl's session and controlling terminal.
//
