...
func (m *BackgroundShellManager) Start(ctx context.Context, workingDir string, blockFuncs []BlockFunc, guards []Guard, command string, description string) (*BackgroundShell, error) {
	// Check job limit
