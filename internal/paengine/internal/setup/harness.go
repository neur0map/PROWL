...
//
// Scope is deliberately limited to omp, claude, hermes, and prowl (the
// harnesses with a native skill system prowl targets); other clients stay
...
func DetectInstalledHarnesses() []string {
	...
	if harnessPresent(home, ".config/prowl", "prowl") {
