...
// enabled and reachable, and the refresh it runs embeds within a bounded budget
// so the answer is never held up by a vector rebuild; structural commands pass
// false to skip the embedder probe and stay fast.
