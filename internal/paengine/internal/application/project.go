...
import (
	...
	"github.com/neur0map/prowl/internal/paengine/internal/query"
	"github.com/neur0map/prowl/internal/paengine/internal/review"
...
func assembleProject(
	...
	project.Review = review.NewService(review.ServiceOptions{
		...
		Refresh: func(ctx context.Context) (string, error) {
			...
			return database.GetMetaContext(ctx, "cli_sig")
		},
	})
