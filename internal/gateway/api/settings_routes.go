...
func (s *Server) registerSettingsRoutes() {
	...
	s.mux.HandleFunc("GET /api/settings/version", s.RequireSession(handleSettingsVersion))
	s.mux.HandleFunc("GET /api/settings/update-check", s.RequireSession(store.handleGetUpdateCheck))
	s.mux.HandleFunc("PUT /api/settings/update-check", s.RequireSession(store.handlePutUpdateCheck))
	s.mux.HandleFunc("GET /api/settings/api-key", s.RequireSession(store.handleGetAPIKey))
	s.mux.HandleFunc("POST /api/settings/api-key/regenerate", s.RequireSession(store.handleRegenerateAPIKey))

	s.mux.HandleFunc("GET /api/update/release", s.RequireSession(update.handleRelease))
	s.mux.HandleFunc("GET /api/update/check", s.RequireSession(update.handleCheck))
	s.mux.HandleFunc("GET /api/update/status", s.RequireSession(update.handleStatus))
}
...
const (
	...
	unifiedAPIKeyPrefix = "prowl-gate-"
...
func handleSettingsVersion(w http.ResponseWriter, _ *http.Request, _ gateway.SessionUser) {
	WriteJSON(w, http.StatusOK, map[string]any{"version": settingsAppVersion()})
}

func (st *settingsStore) handleGetUpdateCheck(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
	WriteJSON(w, http.StatusOK, map[string]any{"enabled": st.autoUpdateCheckEnabled(r.Context())})
}

func (st *settingsStore) handlePutUpdateCheck(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
	var body struct {
...
func (st *settingsStore) handleGetAPIKey(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
...
func (st *settingsStore) handleRegenerateAPIKey(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
...
func (u *updateChecker) handleRelease(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
...
func (u *updateChecker) handleCheck(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
	WriteJSON(w, http.StatusOK, u.check(r.Context()))
}

func (u *updateChecker) handleStatus(w http.ResponseWriter, _ *http.Request, _ gateway.SessionUser) {
	status := "unsupported"
