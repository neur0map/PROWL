...
func (s *Server) registerKeyActivityRoutes() {
	s.mux.HandleFunc("GET /api/keys/activity", s.RequireSession(s.handleKeysActivity))
}

func (s *Server) handleKeysActivity(w http.ResponseWriter, r *http.Request, _ gateway.SessionUser) {
