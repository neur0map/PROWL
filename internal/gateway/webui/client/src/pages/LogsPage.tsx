  ...
  return (
    <div>
      {(() => {
        ...
        // Embedded in Activity the shell owns the heading, but these
        // controls are this view's own and must stay reachable.
        return embedded
          ? <div className="mb-4 flex flex-wrap items-center justify-end gap-2">{controls}</div>
          : <PageHeader title={t('logs.title')} description={t('logs.description')} actions={controls} />
      })()}
