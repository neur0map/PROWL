...
// do. The first fix shipped in six locales only; these tests hold all 60. The
// premise — intelligence is one weighted axis, never a routing veto — is
// enforced in Go, by the scorer tests in internal/gateway.
