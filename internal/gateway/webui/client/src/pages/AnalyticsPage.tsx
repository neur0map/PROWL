  ...
  return (
    <div className="analytics-viz">
      ...
      {(() => {
        ...
        // Embedded inside Activity, the page header belongs to the shell; only
        // the range picker is still this view's own control.
        return embedded
          ? <div className="mb-4 flex justify-end">{rangePicker}</div>
          : <PageHeader title={t('analytics.title')} description={t('analytics.description')} actions={rangePicker} />
      })()}
