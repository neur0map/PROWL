...
// What the router did with one key over the last day. `hops` counts attempts
// that failed and were retried elsewhere: a key can look healthy and still
// contribute nothing but failed hops, which is invisible in `served`.
