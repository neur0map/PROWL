...
export function CommandPalette() {
  ...
  const commands = useMemo<Command[]>(() => {
    ...
    const pages: Command[] = [
      { id: 'p-models', group: 'pages', label: t('catalog.title'), keywords: 'models catalog browse chat search', icon: MessageSquare, run: go('/models') },
      { id: 'p-embeddings', group: 'pages', label: t('models.embeddingsTab'), keywords: 'models embeddings vectors', icon: Layers, run: go('/models?modality=embeddings') },
      { id: 'p-image', group: 'pages', label: t('models.imageTab'), keywords: 'models image generation', icon: ImageIcon, run: go('/models?modality=image') },
      { id: 'p-video', group: 'pages', label: t('models.videoTab'), keywords: 'models video text to video generation mp4', icon: Clapperboard, run: go('/models?modality=video') },
      { id: 'p-audio', group: 'pages', label: t('models.audioTab'), keywords: 'models audio speech tts stt transcription whisper', icon: AudioLines, run: go('/models?modality=audio') },
      ...
      { id: 'p-providers', group: 'pages', label: t('providerDir.title'), keywords: 'providers directory keys latency reliability quota', icon: KeyRound, run: go('/providers') },
      { id: 'p-routing', group: 'pages', label: t('routing.title'), keywords: 'routing strategy lists order chains budget', icon: Layers, run: go('/routing') },
      ...
      { id: 'p-keys', group: 'pages', label: t('nav.keys'), keywords: 'keys api tokens credentials', icon: KeyRound, run: go('/keys') },
      { id: 'p-agents', group: 'pages', label: t('nav.agents'), keywords: 'agents claude codex cline ollama gemini', icon: Bot, run: go('/agents') },
      { id: 'p-activity', group: 'pages', label: t('activity.title'), keywords: 'activity analytics usage stats savings latency logs quota', icon: ChartColumn, run: go('/activity') },
