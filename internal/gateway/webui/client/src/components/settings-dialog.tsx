...
const RELEASES_URL = 'https://github.com/neur0map/prowl/releases'
              ...
              <div className="space-y-4">
                ...
                {info.installation === 'source' && (
                  <div className="space-y-2">
                    <div className="flex gap-2 rounded-xl border bg-muted/30 p-3">
                      <SquareTerminal className="mt-0.5 size-4 shrink-0 text-muted-foreground" />
                      <code className="whitespace-pre-wrap break-all font-mono text-[11px]">git fetch https://github.com/neur0map/prowl.git main && git merge --ff-only FETCH_HEAD && CGO_ENABLED=1 GOEXPERIMENT=greenteagc GOFLAGS=-tags=sqlite_fts5 go build .</code>
                    </div>
                ...
                {(info.installation === 'desktop' || info.installation === 'unknown') && (
                  <a
                    href="https://github.com/neur0map/prowl/releases/latest"
                    target="_blank"
