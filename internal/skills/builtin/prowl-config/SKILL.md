---
name: prowl-config
description: Use when the user needs help configuring Prowl — writing prowlrc (the Bash config format) or prowl.json, setting up providers, models, LSPs, MCP servers, hooks, skills, permissions, or changing Prowl behavior.
---
