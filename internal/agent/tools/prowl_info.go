...
const ProwlInfoToolName = "prowl_info"

//go:embed prowl_info.md
var prowlInfoDescription string

type ProwlInfoParams struct{}

func NewProwlInfoTool(
	...
	return fantasy.NewAgentTool(
		ProwlInfoToolName,
		prowlInfoDescription,
		func(ctx context.Context, _ ProwlInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildProwlInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildProwlInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
