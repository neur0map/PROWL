...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "prowl.log")
...
func TestNewProwlLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewProwlLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, ProwlLogsToolName, tool.Info().Name)
}

func TestProwlLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 3})
...
func TestProwlLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 0})
...
func TestProwlLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestProwlLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runProwlLogs("/nonexistent/path/prowl.log", ProwlLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestProwlLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "prowl.log")
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestProwlLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "prowl.log")
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 10})
...
func TestProwlLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 1})
...
func TestProwlLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestProwlLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestProwlLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestProwlLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "prowl.log")
...
func TestProwlLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "prowl.log")
...
func TestProwlLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestProwlLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestProwlLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestProwlLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runProwlLogs(logFile, ProwlLogsParams{Lines: 5})
...
func TestProwlLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
