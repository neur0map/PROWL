...
func TestProwlInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildProwlInfo(cfg, nil, nil, nil, nil)
...
func TestProwlInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/prowl/prowl.json",
		"/project/.prowl/prowl.json",
	)
	output := buildProwlInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/prowl/prowl.json")
	require.Contains(t, output, "/project/.prowl/prowl.json")
}

func TestProwlInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildProwlInfo(cfg, mgr, nil, nil, nil)
...
func TestProwlInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.prowl",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.prowl")
	require.Contains(t, output, "debug = true")
}

func TestProwlInfo_TUIOptions(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_TUIOptionsUnpinnedCompletionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildProwlInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildProwlInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestProwlInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "prowl.json")
	...
	output := buildProwlInfo(store, nil, nil, nil, nil)
...
func TestProwlInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "prowl-config", Builtin: true},
	}
	...
	output := buildProwlInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "prowl-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestProwlInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "prowl-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestProwlInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestProwlInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
