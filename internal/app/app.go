...
import (
	...
	"github.com/neur0map/prowl/internal/update"
...
type App struct {
	...
	// subscribers (notably `prowl run` in client/server mode) can
...
// for `prowl run`. A lossy fan-in here can drop the only terminal
