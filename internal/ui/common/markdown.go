...
import (
	...
	"github.com/neur0map/prowl/internal/ui/xchroma"
)

const formatterName = "prowl"
...
// API). Prowl's TUI is single-threaded so production never
...
// charmbracelet/prowl#3502). Preserving newlines keeps the display faithful.
//
